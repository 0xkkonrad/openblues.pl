...
<section class="stay-map" id="venue-map" aria-labelledby="map-title">
  ...
  <p class="stay-map__intro">Retraced from the supplied Sheet map. Layout is approximate: no scale or confirmed door and furniture positions. Bed symbols summarize inventory rather than exact placement. Names and availability stay in the Room Browser. Tower and Barn are orientation only; the new Opposite Right room is not on the supplied plan.</p>
