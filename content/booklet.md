---
title: "2026 Info Booklet"
subtitle: "Everything you need to know before coming to Open Blues."
description: "Practical information for Open Blues 2026: the venue, ride sharing, accommodation, food, festival rules, payments, schedule and packing checklist."
url: /booklet/
---
...
Open Blues is a non-profit do-it-yourself event. The main organisers deal with renting the venue, registrations, scheduling and some logistics, but music, workshops and merriment are crowdsourced. Not only is this more fun and creates a well-knit community, but it also reduces the costs from ~€450 pp to ~€120 pp!
...
- If you booked a **bed**, you'll have a bed or big mattress with fresh sheets, pillows etc. This will be in a shared room and is the most comfortable option.
- If you booked a **mattress**, there are no sheets. You have to carry your mattress, find a suitable spot for it and bring it back to where it was before. The advantage of this option is that you can put it wherever you like — so if you are a snorer or have very light sleep, you can probably find a nice spot. Unless you have a dust allergy, the barn is a great spot too. The disadvantage is that you have to arrange it yourself.
- If you have the **tent or floor** option, you probably know what you are doing. There is plenty of space and you can choose where you would like to stay.
...
- You have to ask at least three participants before asking Konrad.
- If something feels wrong, tell a trusted person from the Committee.
...
Please [register here](https://forms.gle/Y9bHtPcDKLdtcGGj6). There are two steps:

1. **The Reservation Payment.** The prepayment is non-refundable, but you can find someone to take your spot if you can't go. This goes towards our fixed costs such as bands.
2. **Cash payment at the venue.** This is calculated based on how many nights you stay, how much you drink etc. When you registered, you were asked to write down the amount. If you have booked a bed or double bed, you will also have to fill out the [2026 Accommodation Form](https://docs.google.com/spreadsheets/u/0/d/19T-Rd5g3_WW2lPVXQmSLRSTZWI928Ai6Q9gG2UMpCwM/edit).

If you can't bring Euros, use 4.50 PLN = 1 EUR as the conversion rate for PLN (sorry).

## Preliminary schedule

| Day | Programme |
|---|---|
| Thursday | Welcome · Late Party |
...
| Monday | Breakfast · Cleaning · Goodbyes! |
...
- Sheets or sleeping bag (if you booked a mattress)
